...
- `!save` → Run the Save Answer Back to Knowledge Base prompt
- `!promote` → Run the Promote a Strategy from TESTING to ACTIVE prompt
- `!retire` → Run the Retire a Strategy prompt
- `!rulechange` → Run the Rule Change — Update Wiki prompt